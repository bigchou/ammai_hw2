...
class SphereFace(nn.Module):
    ...
    def forward(self, input):
        """
        torch.Size([64])
        tensor([1, 1, 0, 1, 2, 3, 2, 0, 6, 4, 6, 1, 9, 4, 8, 1, 7, 4, 8, 9, 8, 6, 5, 0,
        2, 5, 5, 3, 6, 7, 9, 0, 2, 3, 2, 0, 6, 6, 4, 6, 5, 3, 6, 5, 2, 2, 2, 1,
        9, 0, 5, 4, 0, 3, 5, 4, 3, 3, 5, 0, 7, 4, 8, 0])
        """

        #print(input.shape) #(105,512) for meta-train
        #print(input.shape) #(100,512) for meta-test

        #label = np.concatenate((np.repeat(range(5), 5), np.repeat(range(5), 15)), axis=0)#for meta-test
        #label = np.concatenate((np.repeat(range(5), 5), np.repeat(range(5), 16)), axis=0)#for meta-train

        num = input.shape[0]#105 or 100
        num = (num-25)/5# 15 or 16
        label = np.concatenate((np.repeat(range(5), 5), np.repeat(range(5), num)), axis=0)#for meta-train
